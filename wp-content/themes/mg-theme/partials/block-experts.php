<?php if( get_field('experts_title') || get_field('experts_text') || have_rows('experts_items') ): ?>
  <section class="experts">
    <div class="container">
      <?php if( get_field('experts_title') || get_field('experts_text') ): ?>
      ...
      <?php endif; ?>
      <?php if( have_rows('experts_items') ): $experts_index = 0; ?>
        <div class="experts__row">
          <?php while( have_rows('experts_items') ): the_row(); $experts_index++; ?>
